...
namespace Swan.Core.Service
{
    public class BlogService : IBlogService
    {
        ...
        {
            BlogPost result = await _store.AddPostAsync(obj);
            return result;
        }
        ...
        {
            BlogTag result = await _store.AddTagAsync(obj);
            return result;
        }

        public async Task<BlogTag> UpdateTagAsync(BlogTagObject obj)
        {
            BlogTag result = await _store.UpdateTagAsync(obj);
            return result;
        }
        ...
        {
            List<BlogSeries> allSeries = await _store.GetBlogSeriesAsync(true);
            return allSeries.FirstOrDefault(x => x.Object.Id == id);
        }

        public async Task<BlogSeries> GetSeriesByUrlAsync(string url, bool isAdmin)
        {
            List<BlogSeries> allSeries = await _store.GetBlogSeriesAsync(isAdmin);
        ...
        {
            List<BlogSeries> result = await _store.GetBlogSeriesAsync(isAdmin);
        ...
        {
            BlogSeries result = await _store.AddSeriesAsync(obj);
            return result;
        }

        public async Task<BlogSeries> UpdateSeriesAsync(BlogSeriesObject obj)
        {
            BlogSeries result = await _store.UpdateSeriesAsync(obj);
            return result;
        }
