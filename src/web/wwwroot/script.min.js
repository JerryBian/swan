...
</div>`;document.querySelector("#temp").innerHTML=headerClass,bootstrap.Toast.getOrCreateInstance(document.querySelector("#"+id)).show()}function makeId(){return"id"+Math.random().toString(16).slice(2)}"object"==typeof exports&&"undefined"!=typeof module&&(module.exports=hljs);