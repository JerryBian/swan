...
namespace Laobian.Web.TagHelpers;
...
public class PageTagHelper : TagHelper
{
    ...
    public override void Process(TagHelperContext context, TagHelperOutput output)
    {
        ...
        output.Attributes.SetAttribute("class", "my-5 small");
    ...
    {
        return $"<li class='page-item active border-0'><span class='page-link'>{item}</span></li>";
    }
