namespace Laobian.Share.BlogEngine
{
    ...
    {
        public const string PostMarkdownExtension = ".md";
        ...
        public const string FileRequestPath = "/static";

        public const string MetadataLine = "---";

        public const string ColonSplitter = ":";
        ...
        public const string DefaultTagName = "未分类";

        public const string DefaultTagLink = "untitled";
