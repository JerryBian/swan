...
public class ReadItemRuntime
{
    ...
    [DataMember(Order = 1)] public ReadItem Raw { get; set; }

    [DataMember(Order = 2)] public string ShortCommentHtml { get; set; }

    [IgnoreDataMember] public string BlogPostTitle { get; set; }
