...
dotnet user-secrets set "API_REQUEST_TOKEN" "$API_REQUEST_TOKEN" --project $BLOG_PROJECT
...
dotnet user-secrets set "API_REQUEST_TOKEN" "$API_REQUEST_TOKEN" --project $API_PROJECT
...
dotnet user-secrets set "API_REQUEST_TOKEN" "$API_REQUEST_TOKEN" --project $ADMIN_PROJECT
